...
import scipy as sp
from preprocessing.horizontal_inefficiency import horizontal_ineff
...
def data_preprocessing(departure,arrival):
    ...
    path_cluster = "Database/Data4Clustering/"+departure+"/"
    ...
    path_HFE_isExist = os.path.exists(path_HFE)

    if not path_HFE_isExist:
        # Create a new directory because it does not exist 
        os.makedirs(path_HFE)
        print("The new directory was created!")
